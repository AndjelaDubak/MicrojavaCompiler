...
public class StatementSingleNoLabelColon extends Statement {

    private SingleStatement SingleStatement;

    public StatementSingleNoLabelColon (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementSingleNoLabelColon(\n");
