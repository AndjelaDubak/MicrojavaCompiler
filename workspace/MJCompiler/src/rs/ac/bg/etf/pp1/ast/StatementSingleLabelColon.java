...
public class StatementSingleLabelColon extends Statement {

    private Label Label;
    private SingleStatement SingleStatement;

    public StatementSingleLabelColon (Label Label, SingleStatement SingleStatement) {
        this.Label=Label;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementSingleLabelColon(\n");
